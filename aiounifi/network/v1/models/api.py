"""Request and response typing for UniFi Network Integration API v1."""
...
@dataclass
class ApiRequest:
    """Data class with required properties for Integration API requests."""
    ...
    def decode(self, raw: bytes) -> ApiResponse:
        """Decode a paginated Network Integration API envelope."""
