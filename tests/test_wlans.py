...
def test_ports():
    ...
    assert wlans[key].minrate_ng_enabled is False
    assert wlans[key].minrate_ng_mgmt_rate_kbps == 1000
    assert wlans[key].name == "SSID 1"
    assert wlans[key].no2ghz_oui is False
