...
@pytest.mark.parametrize("test_data", data_test_outlet)
async def test_outlet(unifi_controller, test_data):
    """Verify that device outlet model works."""
    unifi_controller.devices.process_raw([test_data["device"]])
